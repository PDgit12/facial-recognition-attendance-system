...
def contact():
    mess._show(title='Contact us', message="Please contact us on : 'piyushdua01@gmail.com' ")
...
message3 = tk.Label(window, text="PROTOTYPE1" ,fg="white",bg="#262523" ,width=55 ,height=1,font=('times', 29, ' bold '))
